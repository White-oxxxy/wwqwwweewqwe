...
all_users_back_to_search_kb: ReplyKeyboardMarkup = all_users_back_to_search_kb_builder.as_markup(
    one_type_keyboard=True,
    resize_keyboard=True
)
...
all_users_text_showing_interaction_kb_builder.row(*all_users_text_showing_interaction_buttons, width=3)

all_users_text_showing_interaction_kb: ReplyKeyboardMarkup = all_users_text_showing_interaction_kb_builder.as_markup(
    one_type_keyboard=True,
    resize_keyboard=True
)